...
def get_applications_by_benchmark(benchmark):
    ...
    benchmarks = {
        "SPLASH": [
            "BARNES", "CHOLESKY", "FFT", "FMM", "LU-CONT", "LU-NOCONT", 
            "OCEAN-CONT", "OCEAN-NOCONT", "RADIOSITY", "RAYTRACE", 
            "RADIX", "VOLREND", "VOLREND-NPL", "WATER-SPATIAL", "WATER-NSQUARED"
        ],
        "NAS": [
        ...
        for config in configs:
            for app in applications:
                if benchmark == "SPLASH":
                    ...
                    app_dir = cd_to_app_dir(benchmark_dir, app)
                else:
                    app_name = app
                    app_dir = benchmark_dir
