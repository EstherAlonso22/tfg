...
def main(benchmark):
    ...
    for benchmark in benchmarks:
        ...
        for config in configs:
            ...
            df = pd.DataFrame(all_data, columns=["App"] + num_IQs)

            # Definir la ruta del archivo CSV de salida
            output_csv_file = os.path.join(os.getcwd(), f"ipc_results_divided_{benchmark}_{config}.csv")
