from m5.objects import SimpleBTB, TournamentBP, ReturnAddrStack, MultiperspectivePerceptron8KB, TAGE_SC_L_64KB
...
class TAGE_BP(TAGE_SC_L_64KB):
    def __init__(self):
        super(TAGE_BP, self).__init__()
