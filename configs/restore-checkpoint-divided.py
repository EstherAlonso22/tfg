...
def parse_arguments():
    ...
    parser.add_argument("--config", type=str, choices=["bigO3", "smallO3", "generalBigO3", "generalSmallO3"], default="bigO3", help="Select the processor configuration: bigO3, smallO3, or generalO3(generic ports)")
